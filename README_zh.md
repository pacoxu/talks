...
|------|------|-----------|---------|------|--------|
| 2026 | KCD 北京 | - | 超大集群还是多集群？识别瓶颈所在 | 中文 | [幻灯片](https://github.com/pacoxu/talks/blob/main/tasks/kcd-beijing-2026-huge-cluster/dist/Huge-Cluster-or-Multi-Clusters-KCD-Beijing-2026.pptx) |
...
| 2023 | KubeCon 中国（上海） | Xiongxiong Yuan | Kubernetes SIG Node 介绍与深度解析 | 英文 | [会议链接](https://kccncosschn2023.sched.com/event/4a2746baff6af89d668edc2eabbcf906) |
| 2023 | KubeCon 中国（上海） | Byron Wang | 如何在大规模集群中加速节点上的 Pod 启动？ | 英文 | [会议链接](https://sched.co/1PTFR) |
| 2023 | KubeCon 欧洲（阿姆斯特丹） | Rohit Anand | Kubeadm 深度解析 | 英文 | [会议链接](https://kccnceu2023.sched.com/event/1Iki0/kubeadm-deep-dive-rohit-anand-nec-paco-xu-dao-cloud) |
| 2021 | KubeCon 中国（线上） | - | Kubernetes SIG Node：介绍与深度解析 | 中文 | [会议链接](https://kccncosschn21.sched.com/event/pccE/kubernetes-sig-nodedaeptao-ye-ge-kubernetes-sig-node-intro-and-deep-dive-paco-daocloud) |
| 2021 | KCD 上海 | - | Kubeadm & SIG Node 介绍与如何参与贡献 | 中文 | [幻灯片](https://github.com/cncf/presentations/tree/main/chinese/kcd-shanghai) |
